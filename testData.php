...
Class testData{
	...
	{
		return md5(substr(str_shuffle('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890'),0,rand(15,30)));
	}
	public function createBirthday()
	{
		return date('Y-m-d',time()-rand((60*60*24*365),(60*60*24*18000)));
	}
	...
	{
		return base64_encode(substr(str_shuffle('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890'),0,rand(15,30)));
	}
	public function createEmail()
	{
		$emailArray = ['qq.com','163.com','126.com','yahoo.com','qq.vip.com','baidu.com','gmail.com','mail.com','top.com','sina.com'];
		return substr(str_shuffle('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890'),0,rand(6,15)).'@'.$emailArray[rand(0,count($emailArray)-1)];
	}
	public function createUsername()
	{
		return substr(str_shuffle('qwertyuiopasdfghjklzxcvbnm'),0,rand(6,8)).substr(str_shuffle('0123456789'),0,rand(0,5));
	}
	public function createRealname(){
		$result = NULL;
